      ...
      <section id="contact" className="px-6 md:px-12 lg:px-24 py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:items-center">
          ...
          <div className="md:justify-self-end md:text-right">
            <iframe
                src="https://docs.google.com/forms/d/e/1FAIpQLScsWgxDNTY4rQ6L1JolxMCLm9HjFYxDkKFFewLj8UogdafKoA/viewform?embedded=true"
                width="640" height="900">Loading…
            </iframe>
          </div>
        </div>
        ...
        <div className="border-t border-neutral-300 mt-12 pt-12">
          <div className="flex justify-between items-center">
            ...
            <div className="flex space-x-4">
              <a href="#"
                 className="text-xs uppercase hover:text-neutral-500 transition-colors">{t('contact.social.instagram')}</a>
              <a href="#"
                 className="text-xs uppercase hover:text-neutral-500 transition-colors">{t('contact.social.facebook')}</a>
              <a href="#"
                 className="text-xs uppercase hover:text-neutral-500 transition-colors">{t('contact.social.pinterest')}</a>
            </div>
          </div>
        </div>
